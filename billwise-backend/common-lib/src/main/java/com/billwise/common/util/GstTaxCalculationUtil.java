...
/**
 * Shared GST calculation engine for Indian GST compliance.
 * Handles intrastate (CGST + SGST) vs interstate (IGST) split, zero-rated exports, and precision rounding.
 */
public class GstTaxCalculationUtil {
    ...
    public static TaxBreakdown calculateTaxes(BigDecimal taxableAmount, Double gstRate, String supplierStateCode, String recipientStateCode, String supplyType) {
        ...
        // Exports & SEZ supplies are zero-rated under statutory GST provisions
    ...
    private static String cleanStateCode(String input) {
        ...
        // If passed full GSTIN (15 chars), extract first 2 digits
